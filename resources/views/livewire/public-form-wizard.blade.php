<div
    ...
    <div
        ...
        class="fixed top-4 right-4 z-50 w-80 rounded-xl bg-emerald-950 border border-emerald-800/50 shadow-2xl p-4">
        <div class="flex items-start gap-3 mb-3">
            <div class="shrink-0 mt-0.5 w-8 h-8 rounded-lg flex items-center justify-center bg-emerald-900/60">
                <svg class="w-4 h-4 text-emerald-300" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="flex gap-2">
            <button type="button" @click="restoreDraft()"
                class="flex-1 py-1.5 rounded-lg text-xs font-semibold transition-colors bg-emerald-800/50 text-emerald-200 border border-emerald-700/50 hover:bg-emerald-700/60">
                Restaurar
            </button>
            <button type="button" @click="clearDraft()"
                class="flex-1 py-1.5 rounded-lg text-xs font-medium transition-colors bg-white/5 text-zinc-400 border border-white/10 hover:text-zinc-200 hover:bg-white/10">
                Descartar
            </button>
        </div>
    </div>
